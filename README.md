...
- **Model Evaluation:** This project implements a comprehensive regression model evaluation framework using GridSearchCV to systematically compare multiple machine learning algorithms. By leveraging Linear Regression, Lasso, and Decision Tree models, the evaluation process conducts hyperparameter tuning through 5-fold cross-validation, generating robust performance metrics including Mean Absolute Error (MAE) and R-squared score. 
